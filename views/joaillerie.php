...
<head>
    ...
    <title>ShopEsa - Joaillerie</title>
...
<body>
    ...
    <header class="header">
        ...
        <nav class="nav-links">
            ...
            <a href="joaillerie.php" class="active">Joaillerie</a>
    ...
    <section class="section">
        <div class="section-head">
            <div>
                <div class="section-eyebrow">Collection Joaillerie</div>
                <h2>Joaillerie</h2>
            </div>
        </div>
    ...
    <script src="../public/js/joaillerie.js"></script>
</body>
